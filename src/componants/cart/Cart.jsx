                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3 mt-4">
                      ...
                      <span className="badge badge-outline">{c.material}</span>

                      <span className="badge badge-outline">{c.color}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-6 gap-4">
                    ...
                    <div className="flex gap-3">
                     ...
                     <DeleteCart c={c} setCart={setCart}/>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white mt-10 rounded-3xl shadow-md p-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div>
                ...
                <p className="text-gray-500">Ready to complete your order?</p>
              </div>
